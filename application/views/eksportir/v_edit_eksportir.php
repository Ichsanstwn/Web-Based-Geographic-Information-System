                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex">
                                ...
                                <select class="form-control selectpicker" data-live-search="true" name="jenis_prshn" id="jenisPrshn" required>
                                    <option value="" selected disabled>-Belum dipilih-</option>
                                    <?php foreach ($jenis as $j) : ?>
                                        <?php if ($j['id_jenis_prshn'] == $eksportir['id_jenis_prshn']) : ?>
                                            <option value="<?= $j['id_jenis_prshn']; ?>" selected><?= $j['jenis_prshn']; ?></option>
                                        <?php else : ?>
                                            <option value="<?= $j['id_jenis_prshn']; ?>"><?= $j['jenis_prshn']; ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </select>
                            </div>
